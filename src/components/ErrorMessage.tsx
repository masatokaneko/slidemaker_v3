...
const ErrorMessage: React.FC<ErrorMessageProps> = ({ error, onDismiss }) => {
  ...
  return (
    <div
      className="my-4 p-4 bg-red-100 border border-red-400 text-red-700 rounded-md relative"
      role="alert"
    >
      ...
      {error.details && (
        <details className="mt-2 text-sm">
          ...
          <pre className="mt-1 p-2 bg-red-50 rounded text-xs whitespace-pre-wrap break-all">
            {error.details}
          </pre>
        </details>
      )}
